...
class ErrorMessages{
    ...
    public function __construct(){
        ...
        $this->errorList = [
            ...
            ErrorMessages::ERROR_PETICIONPAGO_ENVIAR     => 'No se pudo Enviar la planilla. Trate de nuevo',
            ...
            ErrorMessages::ERROR_PRESTAMOS_NEWPRESTAMO_EMPTY    => 'Error al crear el adelanto de pago.', 
