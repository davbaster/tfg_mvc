...
//Hay algoritmos para ordenar por fecha, por planilla, por estado
    ...
    async function getPrestamos(){
        ...
        data = await fetch('http://localhost:41062/www/prestamos/getPrestamosAutorizados')
        .then(res =>res.json())
        .then(json => json);
            ...
            case "autorizado":
                ...
                divInfoPrestamo.innerHTML +=
                    `<div class="planilla-item" id="view-info-acciones">
                        <a id="cerrarPrestamo href="#" onclick="cerrarFormularioPrestamo(${id_prestamo})">Cerrar</a>
                        <a id="pagarItem" href="#" onclick="pagarPrestamo(${id_prestamo})">Pagar</a>
    ...
    //Esta funcion al ser asyncrona usa promises
    //https://web.dev/promises/ , https://stackoverflow.com/questions/37533929/how-to-return-data-from-promise
    async function pagarPrestamo(idPrestamo){

    event.preventDefault();

    data = await fetch(`http://localhost:41062/www/prestamos/pagar/${idPrestamo}`)
    .then(res =>res.json())
    .then(json => json);
